...
class AppUtilsTest {
  ...
  void testIpAddressParsing() {
    Assertions.assertArrayEquals(
        new byte[] {(byte) 0xFF, 0x01, 0x00, 0x03}, AppUtils.parseIpAddress("255.1.0.3"));
    Assertions.assertArrayEquals(
        new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF},
        AppUtils.parseIpAddress("255.255.255.255"));
    Assertions.assertArrayEquals(
        new byte[] {0x0A, 0x0B, 0x0C, 0x0D}, AppUtils.parseIpAddress("10.11.12.13"));
  }
